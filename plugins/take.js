...
Module({
    ...
    if (stickermsg) {
        ...
        var exif = {
            ...
            android: "https://github.com/Diegoson/AMAROK-MD/",
            ios: "https://github.com/Diegoson/AMAROK-MD/"
        } }
        else {
            var exif = {
    ...
    if (!stickermsg && audiomsg) {
                ...
                var res = await addInfo(q,spl[0],spl[1]?spl[1]:AUDIO_DATA.split(";")[1], 'Amarok Engine', image)
